...
def question_16_9(query):
    line1 = Line.get_line_contains_points(Point(-3, 1), Point(0, -3))
    line2 = line2 = Line(1, 0, 3)
...
def question_16_13(query):
    line1 = Line.get_line_contains_points(Point(-3, 2), Point(-1, 3))
    line2 = Line.get_line_contains_points(Point(2, 3), Point(3, 1))
